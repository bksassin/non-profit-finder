...
import { ExternalLink, MapPin, Tag, Info, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="h-full glass glass-hover rounded-2xl overflow-hidden shadow-lg">
        ...
        <div className={`p-6 ${nonprofit.coverImageUrl && nonprofit.logoUrl ? 'pt-12' : ''}`}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <a
              href={nonprofit.slug ? `https://www.every.org/${nonprofit.slug}#/donate` : nonprofit.websiteUrl}
              target="_blank"
              rel="noopener noreferrer"
